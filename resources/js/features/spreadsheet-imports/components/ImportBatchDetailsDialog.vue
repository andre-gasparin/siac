...
import { AlertTriangle, Download, X } from '@lucide/vue';
...
import { formatBrazilianDate } from '@/shared/lib/utils';
...
function formatDateTime(val?: string | null): string {
    ...
    const formattedDate = formatBrazilianDate(datePart);
        ...
        <DialogContent class="flex max-h-[90vh] flex-col p-6 sm:max-w-4xl">
            <DialogHeader>
                <DialogTitle class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <span>Dados Importados do Lote</span>
                        <span
                ...
                <DialogDescription>
                    Visualização das medições efetivadas no banco de dados para
                    este lote.
                </DialogDescription>
            </DialogHeader>
            ...
            >
                ...
                >
                    ...
                    />
                    <span class="text-xs">Carregando detalhes do lote...</span>
                </div>
            </div>

            <div
                v-else-if="preview"
                class="flex min-h-0 flex-1 flex-col gap-3 py-2"
            >
                <!-- Stat Cards -->
            ...
            <DialogFooter class="flex items-center pt-2 sm:justify-between">
                ...
                <div class="flex items-center gap-2">
                    <Button v-if="downloadUrl" variant="secondary" as-child>
