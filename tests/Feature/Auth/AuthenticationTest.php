...
test('users belonging only to inactive team cannot login', function () {
    $user = User::factory()->create();
    $user->personalTeam()->update(['is_active' => false]);
...
test('admin users can login even if their team is inactive', function () {
